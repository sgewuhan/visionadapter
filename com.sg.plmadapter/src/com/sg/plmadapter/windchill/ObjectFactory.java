...
public class ObjectFactory {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pm.webservice.integration.tmt.ext/", name = "createDocumentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pm.webservice.integration.tmt.ext/", name = "deleteDocument")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pm.webservice.integration.tmt.ext/", name = "moveDocumentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pm.webservice.integration.tmt.ext/", name = "deleteDocumentResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://pm.webservice.integration.tmt.ext/", name = "moveDocument")
